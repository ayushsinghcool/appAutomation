...
public class FilePaths {
    ...
    public static final String NODE_JS_PATH = MobileProperties.getProperty("os.platform").equalsIgnoreCase("mac")
            ...
            : "C:\\Program Files\\nodejs\\node.exe";
    public static final String SSH_PRIVATE_KEY = "/Users/ayushkumarsingh/.ssh/";
    public static final String NCMC_LOGS = System.getProperty(USER_DIR) + File.separator+"reports"+File.separator+"logs"+File.separator;
